...
namespace Joes_Pizza_Shop.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult AddToCart(int id)
        {
            ...
            if (ModelState.IsValid)
            {
                using (db)
                {
                    ...
                    var obj = db.CustomerOrderTable.Where(model => model.PID == PID.PID && model.Purchased == 0).FirstOrDefault();
                    if (obj != null)
                    {
        ...
        {
            var CartNumbers = (from d in db.CustomerOrderTable where d.Purchased == 0 select d).Count();
        ...
        public IActionResult OrderCheckout()
        {
            ...
            var TotalAmount = (from cot in db.CustomerOrderTable
            ...
            return View(db.CustomerOrderTable.Where(x=> x.Purchased == 0).ToList());
        }
        ...
        public IActionResult IncreaseQuantity(int id)
        {
            ...
            CustomerOrderTable COT = db.CustomerOrderTable.Where(u => u.CustomerOrderID == id && u.Purchased == 0).FirstOrDefault();
        ...
        {
            CustomerOrderTable COT = db.CustomerOrderTable.Find(id);
            db.CustomerOrderTable.Remove(COT);
            db.SaveChanges();
            return RedirectToAction("OrderCheckout");
        }
        ...
        public IActionResult Checkout()
        {
            ...
            List<CustomerOrderTable> COT = db.CustomerOrderTable.Where(u => u.Purchased == 0).ToList();
            Order ord = new Order();
        ...
        public IActionResult OrderConfirmation()
        {
            ...
            ViewData["Orders Details"] = db.CustomerOrderTable.Where(model => model.OrderID == OrderID && model.Purchased == 1).ToList();
